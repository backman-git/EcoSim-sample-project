...
**************************************************************************************************/
// change by backman   combine GAP layer  , will split in future!  
/*********************************************************************
 * INCLUDES
 */
...
//BX 
#define CHECK_BLE_STACK               0x0008
#define CHECK_TIME                    300
#define BleStart                      0x01
#define BleAdv                        0x02
#define BleOptClean                   0x00

//uint8 BleStatus =0x00;
...
#define DEFAULT_ADVERT_OFF_TIME       3000   // 30 seconds
 ...
 * Internal function defined in peripheral.h.
 */
uint16 GAPRole_ProcessEvent( uint8 task_id, uint16 events )__reentrant
{
...
*/
  ...
  if(events & CHECK_BLE_STACK){


      if(CHECK_TIME && BleChecker() == false){


        uartWriteString("GAP ble ckecker====\r\n");

        osal_start_timerEx( gapRole_TaskID, CHECK_BLE_STACK, CHECK_TIME );
...
static void gapRole_SetupGAP( void )
{
  ...
  osal_set_event( gapRole_TaskID, CHECK_BLE_STACK);
...
Status_t GAP_EndDiscoverable( uint8 taskID ){
