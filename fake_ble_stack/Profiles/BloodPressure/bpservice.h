...
// BloodPressure Service UUIDs                                        //////value
...
typedef NULL_OK void (*bloodChange_t)( uint8 paramID );

typedef struct
{
  bloodChange_t        pfnbloodChange;  // Called when characteristic value changes
} bloodCBs_t;
