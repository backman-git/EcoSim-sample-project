...
// Profile UUIDs
#define ACCEL_ENABLER_UUID            0xbac1
#define ACCEL_RANGE_UUID              0xbac2
#define ACCEL_X_UUID                  0xbaa3
#define ACCEL_Y_UUID                  0xbaa4
#define ACCEL_Z_UUID                  0xbaa5
  
// Accelerometer Service UUID
#define ACCEL_SERVICE_UUID            0xBAAC
