...
static uint8 accelXCharProps = GATT_PROP_NOTIFY|GATT_PROP_READ;
static uint8 accelYCharProps = GATT_PROP_NOTIFY|GATT_PROP_READ;
static uint8 accelZCharProps = GATT_PROP_NOTIFY|GATT_PROP_READ;
