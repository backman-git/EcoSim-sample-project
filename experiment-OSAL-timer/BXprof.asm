...
_BX_Tbl:
	.ds 50
_BX_AddService_services_1_297:
	.ds 4
_BX_AddService_status_1_298:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;services                  Allocated with name '_BX_AddService_services_1_297'
;status                    Allocated with name '_BX_AddService_status_1_298'
;------------------------------------------------------------
...
_BX_AddService:
	...
	mov	r5,b
	mov	r4,a
	mov	dptr,#_BX_AddService_services_1_297
	mov	a,r7
	movx	@dptr,a
	mov	a,r6
	inc	dptr
...
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:177: uint8 status = SUCCESS;
	mov	dptr,#_BX_AddService_status_1_298
	mov	a,#0x00
	movx	@dptr,a
...
;------------------------------------------------------------
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:280: static uint8 BX_ReadAttrCB( uint16 connHandle, gattAttribute_t *pAttr, 
;	-----------------------------------------
...
_BX_ReadAttrCB:
	push	_bp
	mov	_bp,sp
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:283: bStatus_t status = SUCCESS;
	mov	r7,#0x00
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:318: if ( gattPermitAuthorRead( pAttr->permissions ) )
	mov	a,_bp
	add	a,#0xfb
	mov	r0,a
	mov	ar4,@r0
	...
	ljmp	00102$
00129$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:321: return ( ATT_ERR_INSUFFICIENT_AUTHOR );
	mov	dpl,#0x08
	ljmp	00112$
00102$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:325: if ( offset > 0 )
	mov	a,_bp
	add	a,#0xf3
	mov	r0,a
	mov	a,@r0
	...
	ljmp	00104$
00130$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:327: return ( ATT_ERR_ATTR_NOT_LONG );
	mov	dpl,#0x0B
	ljmp	00112$
00104$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:331: if ( pAttr->type.len == ATT_BT_UUID_SIZE )
	mov	a,_bp
	add	a,#0xfb
	mov	r0,a
	mov	ar4,@r0
...
00131$:
	ljmp	00110$
00132$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:337: uint16 uuid = BUILD_UINT16( pAttr->type.uuid[0], pAttr->type.uuid[1]);
	mov	a,_bp
	add	a,#0xfb
	mov	r0,a
	mov	ar4,@r0
...
00134$:
	...
	addc	a,r2
	mov	r2,a
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:339: switch ( uuid )
	cjne	r3,#0xD1,00135$
	cjne	r2,#0xDD,00135$
	ljmp	00105$
00135$:
...
00136$:
	ljmp	00107$
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:342: case BX_CHAR1_UUID:
00105$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:344: *pLen = 1;
	push	ar7
	mov	a,_bp
	add	a,#0xf5
	mov	r0,a
	...
	mov	a,#0x01
	lcall	__gptrput
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:345: pValue[0] = *pAttr->pValue;
	mov	a,_bp
	add	a,#0xf8
	mov	r0,a
	mov	ar4,@r0
	...
	mov	a,r2
	lcall	__gptrput
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:348: break;
	pop	ar7
	ljmp	00111$
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:350: case BX_CHAR2_UUID:
00106$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:352: *pLen = 1;
	push	ar7
	mov	a,_bp
	add	a,#0xf5
	mov	r0,a
	...
	mov	a,#0x01
	lcall	__gptrput
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:353: pValue[0] = *pAttr->pValue;
	mov	a,_bp
	add	a,#0xf8
	mov	r0,a
	mov	ar4,@r0
	...
	mov	a,r2
	lcall	__gptrput
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:354: break;
	pop	ar7
	ljmp	00111$
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:363: default:
00107$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:365: *pLen = 0;
	mov	a,_bp
	add	a,#0xf5
	mov	r0,a
	mov	ar4,@r0
	...
	mov	a,#0x00
	lcall	__gptrput
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:366: status = ATT_ERR_ATTR_NOT_FOUND;
	mov	r7,#0x0A
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:368: }
	ljmp	00111$
00110$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:373: *pLen = 0;
	mov	a,_bp
	add	a,#0xf5
	mov	r0,a
	mov	ar4,@r0
	...
	mov	a,#0x00
	lcall	__gptrput
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:374: status = ATT_ERR_INVALID_HANDLE;
	mov	r7,#0x01
00111$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:377: return ( status );
	mov	dpl,r7
00112$:
	pop	_bp
	ret
...
;pCurValue                 Allocated to stack - _bp +1
;------------------------------------------------------------
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:383: static bStatus_t BX_WriteAttrCB( uint16 connHandle, gattAttribute_t *pAttr,
;	-----------------------------------------
...
_BX_WriteAttrCB:
	...
	inc	sp
	inc	sp
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:388: bStatus_t status = SUCCESS;
	mov	r7,#0x00
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:394: if ( gattPermitAuthorWrite( pAttr->permissions ) )
	mov	a,_bp
	add	a,#0xfb
	mov	r0,a
	mov	ar4,@r0
	...
	ljmp	00102$
00138$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:397: return ( ATT_ERR_INSUFFICIENT_AUTHOR );
	mov	dpl,#0x08
	ljmp	00115$
00102$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:402: if ( pAttr->type.len == ATT_BT_UUID_SIZE )
	mov	a,_bp
	add	a,#0xfb
	mov	r0,a
	mov	ar4,@r0
...
00139$:
	ljmp	00113$
00140$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:405: uint16 uuid = BUILD_UINT16( pAttr->type.uuid[0], pAttr->type.uuid[1]);
	mov	a,_bp
	add	a,#0xfb
	mov	r0,a
	mov	ar4,@r0
...
00142$:
	...
	addc	a,r2
	mov	r2,a
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:406: switch ( uuid )
	cjne	r3,#0x02,00143$
	cjne	r2,#0x29,00143$
	ljmp	00114$
00143$:
...
00145$:
	ljmp	00110$
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:409: case BX_CHAR1_UUID:
00103$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:413: if ( status == SUCCESS )
	mov	a,r7
	jz	00146$
	ljmp	00114$
00146$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:418: uint8 *pCurValue = (uint8 *)pAttr->pValue;        
	push	ar7
	mov	a,_bp
	add	a,#0xfb
	mov	r0,a
	...
	inc	r0
	mov	@r0,a
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:422: *pCurValue = pValue[0];
	mov	a,_bp
	add	a,#0xf8
	mov	r0,a
	mov	ar2,@r0
	...
	mov	a,r6
	lcall	__gptrput
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:423: FlashLed= pValue[0];
	mov	dpl,r2
	mov	dph,r3
	mov	b,r7
	lcall	__gptrget
	mov	_FlashLed,a
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:439: break;
	pop	ar7
	ljmp	00114$
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:441: case BX_CHAR2_UUID:
00106$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:445: if ( status == SUCCESS )
	mov	a,r7
	jz	00147$
	ljmp	00114$
00147$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:450: uint8 *pCurValue = (uint8 *)pAttr->pValue;        
	push	ar7
	mov	a,_bp
	add	a,#0xfb
	mov	r0,a
	...
	inc	r0
	mov	@r0,a
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:453: *pCurValue = pValue[0];
	mov	a,_bp
	add	a,#0xf8
	mov	r0,a
	mov	ar2,@r0
	...
	mov	a,r6
	lcall	__gptrput
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:454: MusicCtl= pValue[0];
	mov	dpl,r2
	mov	dph,r3
	mov	b,r7
	lcall	__gptrget
	mov	_MusicCtl,a
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:462: break;
	pop	ar7
	ljmp	00114$
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:470: default:
00110$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:472: status = ATT_ERR_ATTR_NOT_FOUND;
	mov	r7,#0x0A
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:474: }
	ljmp	00114$
00113$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:479: status = ATT_ERR_INVALID_HANDLE;
	mov	r7,#0x01
00114$:
;	../fake_ble_stack/Profiles/BXprofile/BXprof.c:488: return ( status );
	mov	dpl,r7
00115$:
	mov	sp,_bp
	pop	_bp
