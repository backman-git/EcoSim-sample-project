                                      ...
                                      4 ; This file was generated Mon Jun 29 19:13:04 2015
                                      5 ;--------------------------------------------------------
      ...
      0003B7 02 00 03         [24]  899 	ljmp	__sdcc_program_startup
                                    900 ;--------------------------------------------------------
                                    901 ; Home
                                    902 ;--------------------------------------------------------
                                    903 	.area HOME    (CODE)
      ...
      000003 02 03 BA         [24]  906 	ljmp	_main
      ...
      0003BA 75 81 49         [24]  929 	mov	_SP,#0x49
                                    930 ;	./source/SimpleBLEPeripheral_Main.c:90: uartInit(HAL_UART_BR_9600);
      0003BD 75 82 00         [24]  931 	mov	dpl,#0x00
      0003C0 75 83 00         [24]  932 	mov	dph,#0x00
      0003C3 12 3B DF         [24]  933 	lcall	_uartInit
                                    934 ;	./source/SimpleBLEPeripheral_Main.c:112: osal_init_system();
      0003C6 12 1A 7E         [24]  935 	lcall	_osal_init_system
                                    936 ;	./source/SimpleBLEPeripheral_Main.c:130: osal_start_system(); // No Return from here
      0003C9 12 1A 95         [24]  937 	lcall	_osal_start_system
                                    938 ;	./source/SimpleBLEPeripheral_Main.c:139: return 0;
      0003CC 75 82 00         [24]  939 	mov	dpl,#0x00
      0003CF 75 83 00         [24]  940 	mov	dph,#0x00
      0003D2                        941 00101$:
      0003D2 22               [24]  942 	ret
                                    943 	.area CSEG    (CODE)
                                    944 	.area CONST   (CODE)
