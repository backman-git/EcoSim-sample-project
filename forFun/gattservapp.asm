...
_GATTServApp_RegisterService_PARM_3:
	.ds 3
_GATTServApp_RegisterService_pAttrs_1_237:
	.ds 3
_GATTServApp_RegisterService_idx_1_238:
	.ds 2
;--------------------------------------------------------
...
00136$:
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'GATTServApp_AddService'
;------------------------------------------------------------
;services                  Allocated with name '_GATTServApp_AddService_services_1_235'
;------------------------------------------------------------
;	../fake_ble_stack/ble/include/gattservapp.c:310: bStatus_t GATTServApp_AddService( uint32 services ){
;	-----------------------------------------
;	 function GATTServApp_AddService
;	-----------------------------------------
_GATTServApp_AddService:
;	../fake_ble_stack/ble/include/gattservapp.c:314: }
00101$:
	ret
;------------------------------------------------------------
...
;pAttrs                    Allocated with name '_GATTServApp_RegisterService_pAttrs_1_237'
;idx                       Allocated with name '_GATTServApp_RegisterService_idx_1_238'
;------------------------------------------------------------
;	../fake_ble_stack/ble/include/gattservapp.c:321: bStatus_t GATTServApp_RegisterService( gattAttribute_t *pAttrs, uint16 numAttrs,CONST gattServiceCBs_t *pServiceCBs ){
;	-----------------------------------------
...
_GATTServApp_RegisterService:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_GATTServApp_RegisterService_pAttrs_1_237
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	../fake_ble_stack/ble/include/gattservapp.c:323: int idx=ServiceN;
	mov	dptr,#_ServiceN
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_GATTServApp_RegisterService_idx_1_238
	mov	a,r6
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	../fake_ble_stack/ble/include/gattservapp.c:325: if(ServiceN == maxServiceN )
	cjne	r6,#0x0A,00108$
	cjne	r7,#0x00,00108$
	sjmp	00109$
00108$:
	ljmp	00102$
00109$:
;	../fake_ble_stack/ble/include/gattservapp.c:326: return false;
	mov	dpl,#0x00
	ljmp	00103$
00102$:
;	../fake_ble_stack/ble/include/gattservapp.c:333: ServicesTable[idx].service=pAttrs;
	mov	dptr,#_GATTServApp_RegisterService_idx_1_238
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../fake_ble_stack/ble/include/gattservapp.c:334: ServicesTable[idx].CBs=pServiceCBs;
	mov	a,#(_ServicesTable >> 8)
	add	a,r7
	mov	r7,a
	mov	a,#0x03
	...
	inc	dptr
	movx	@dptr,a
;	../fake_ble_stack/ble/include/gattservapp.c:340: BleOpr=0x03;
	mov	_BleOpr,#0x03
;	../fake_ble_stack/ble/include/gattservapp.c:341: ServNH= (ServiceN>>8);
	mov	dptr,#_ServiceN
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	mov	r7,a
	mov	_ServNH,r7
;	../fake_ble_stack/ble/include/gattservapp.c:342: ServNL=ServiceN;
	mov	_ServNL,r6
;	../fake_ble_stack/ble/include/gattservapp.c:345: ServiceN++;
	mov	dptr,#_ServiceN
	mov	a,#0x01
	add	a,r6
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	../fake_ble_stack/ble/include/gattservapp.c:347: return true;
	mov	dpl,#0x01
00103$:
	ret
	.area CSEG    (CODE)
