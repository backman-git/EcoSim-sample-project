      ...
      0010BC                        859 _flag:
      0010BC                        860 	.ds 1
      0010BD                        861 _Task2_Init_task_id_1_65:
      0010BD                        862 	.ds 1
      0010BE                        863 _performPeriodicTask_sloc0_1_0:
      0010BE                        864 	.ds 1
                                    865 ;--------------------------------------------------------
      ...
      0000E2 90 10 BC         [24]  890 	mov	dptr,#_flag
      ...
      003FE0                        911 _Task2_Init:
                           ...
                           000001   918 	ar1 = 0x01
                           000000   919 	ar0 = 0x00
      003FE0 E5 82            [12]  920 	mov	a,dpl
      003FE2 90 10 BD         [24]  921 	mov	dptr,#_Task2_Init_task_id_1_65
      003FE5 F0               [24]  922 	movx	@dptr,a
                                    923 ;	./Source/task2.c:18: TaskID=task_id;
      003FE6 E0               [24]  924 	movx	a,@dptr
      003FE7 FF               [12]  925 	mov	r7,a
      003FE8 90 10 BB         [24]  926 	mov	dptr,#_TaskID
      003FEB EF               [12]  927 	mov	a,r7
      003FEC F0               [24]  928 	movx	@dptr,a
                                    929 ;	./Source/task2.c:23: osal_set_event( TaskID, T2_start );
      003FED 90 03 CB         [24]  930 	mov	dptr,#_osal_set_event_PARM_2
      003FF0 74 01            [12]  931 	mov	a,#0x01
      003FF2 F0               [24]  932 	movx	@dptr,a
      003FF3 74 00            [12]  933 	mov	a,#0x00
      003FF5 A3               [24]  934 	inc	dptr
      003FF6 F0               [24]  935 	movx	@dptr,a
      003FF7 8F 82            [24]  936 	mov	dpl,r7
      003FF9 12 19 D8         [24]  937 	lcall	_osal_set_event
      003FFC                        938 00101$:
      003FFC 22               [24]  939 	ret
                                    940 ;------------------------------------------------------------
                                    ...
                                    949 ;	-----------------------------------------
      003FFD                        950 _Task2_ProcessEvent:
      003FFD C0 1D            [24]  951 	push	_bp
      003FFF 85 81 1D         [24]  952 	mov	_bp,sp
                                    953 ;	./Source/task2.c:40: if ( events & T2_start ){
      004002 E5 1D            [12]  954 	mov	a,_bp
      004004 24 FC            [12]  955 	add	a,#0xfc
      004006 F8               [12]  956 	mov	r0,a
      004007 E6               [12]  957 	mov	a,@r0
      004008 20 E0 03         [24]  958 	jb	acc.0,00115$
      00400B 02 40 43         [24]  959 	ljmp	00102$
      00400E                        960 00115$:
                                    961 ;	./Source/task2.c:46: osal_start_timerEx( TaskID, T2_PERIODIC_EVT, T2_PERIODIC_EVT_PERIOD );
      00400E 90 10 BB         [24]  962 	mov	dptr,#_TaskID
      004011 E0               [24]  963 	movx	a,@dptr
      004012 FF               [12]  964 	mov	r7,a
      004013 90 10 3D         [24]  965 	mov	dptr,#_osal_start_timerEx_PARM_2
      004016 74 02            [12]  966 	mov	a,#0x02
      004018 F0               [24]  967 	movx	@dptr,a
      004019 74 00            [12]  968 	mov	a,#0x00
      00401B A3               [24]  969 	inc	dptr
      00401C F0               [24]  970 	movx	@dptr,a
      00401D 90 10 3F         [24]  971 	mov	dptr,#_osal_start_timerEx_PARM_3
      004020 74 1E            [12]  972 	mov	a,#0x1E
      004022 F0               [24]  973 	movx	@dptr,a
      004023 74 00            [12]  974 	mov	a,#0x00
      004025 A3               [24]  975 	inc	dptr
      004026 F0               [24]  976 	movx	@dptr,a
      004027 A3               [24]  977 	inc	dptr
      004028 F0               [24]  978 	movx	@dptr,a
      004029 A3               [24]  979 	inc	dptr
      00402A F0               [24]  980 	movx	@dptr,a
      00402B 8F 82            [24]  981 	mov	dpl,r7
      00402D 12 27 54         [24]  982 	lcall	_osal_start_timerEx
                                    983 ;	./Source/task2.c:51: return ( events ^ T2_start );
      004030 E5 1D            [12]  984 	mov	a,_bp
      004032 24 FC            [12]  985 	add	a,#0xfc
      004034 F8               [12]  986 	mov	r0,a
      004035 74 01            [12]  987 	mov	a,#0x01
      004037 66               [12]  988 	xrl	a,@r0
      004038 FE               [12]  989 	mov	r6,a
      004039 08               [12]  990 	inc	r0
      00403A 86 07            [24]  991 	mov	ar7,@r0
      00403C 8E 82            [24]  992 	mov	dpl,r6
      00403E 8F 83            [24]  993 	mov	dph,r7
      004040 02 40 8D         [24]  994 	ljmp	00107$
      004043                        995 00102$:
                                    996 ;	./Source/task2.c:55: if( events & T2_PERIODIC_EVT ){
      004043 E5 1D            [12]  997 	mov	a,_bp
      004045 24 FC            [12]  998 	add	a,#0xfc
      004047 F8               [12]  999 	mov	r0,a
      004048 E6               [12] 1000 	mov	a,@r0
      004049 20 E1 03         [24] 1001 	jb	acc.1,00116$
      00404C 02 40 87         [24] 1002 	ljmp	00106$
      00404F                       1003 00116$:
                                   1004 ;	./Source/task2.c:63: osal_start_timerEx( TaskID, T2_PERIODIC_EVT, T2_PERIODIC_EVT_PERIOD );
      00404F 90 10 BB         [24] 1005 	mov	dptr,#_TaskID
      004052 E0               [24] 1006 	movx	a,@dptr
      004053 FF               [12] 1007 	mov	r7,a
      004054 90 10 3D         [24] 1008 	mov	dptr,#_osal_start_timerEx_PARM_2
      004057 74 02            [12] 1009 	mov	a,#0x02
      004059 F0               [24] 1010 	movx	@dptr,a
      00405A 74 00            [12] 1011 	mov	a,#0x00
      00405C A3               [24] 1012 	inc	dptr
      00405D F0               [24] 1013 	movx	@dptr,a
      00405E 90 10 3F         [24] 1014 	mov	dptr,#_osal_start_timerEx_PARM_3
      004061 74 1E            [12] 1015 	mov	a,#0x1E
      004063 F0               [24] 1016 	movx	@dptr,a
      004064 74 00            [12] 1017 	mov	a,#0x00
      004066 A3               [24] 1018 	inc	dptr
      004067 F0               [24] 1019 	movx	@dptr,a
      004068 A3               [24] 1020 	inc	dptr
      004069 F0               [24] 1021 	movx	@dptr,a
      00406A A3               [24] 1022 	inc	dptr
      00406B F0               [24] 1023 	movx	@dptr,a
      00406C 8F 82            [24] 1024 	mov	dpl,r7
      00406E 12 27 54         [24] 1025 	lcall	_osal_start_timerEx
                                   1026 ;	./Source/task2.c:68: performPeriodicTask();
      004071 12 40 90         [24] 1027 	lcall	_performPeriodicTask
                                   1028 ;	./Source/task2.c:73: return( events ^ T2_PERIODIC_EVT);
      004074 E5 1D            [12] 1029 	mov	a,_bp
      004076 24 FC            [12] 1030 	add	a,#0xfc
      004078 F8               [12] 1031 	mov	r0,a
      004079 74 02            [12] 1032 	mov	a,#0x02
      00407B 66               [12] 1033 	xrl	a,@r0
      00407C FE               [12] 1034 	mov	r6,a
      00407D 08               [12] 1035 	inc	r0
      00407E 86 07            [24] 1036 	mov	ar7,@r0
      004080 8E 82            [24] 1037 	mov	dpl,r6
      004082 8F 83            [24] 1038 	mov	dph,r7
      004084 02 40 8D         [24] 1039 	ljmp	00107$
      004087                       1040 00106$:
                                   1041 ;	./Source/task2.c:81: return 0;
      004087 75 82 00         [24] 1042 	mov	dpl,#0x00
      00408A 75 83 00         [24] 1043 	mov	dph,#0x00
      00408D                       1044 00107$:
      00408D D0 1D            [24] 1045 	pop	_bp
      00408F 22               [24] 1046 	ret
                                   1047 ;------------------------------------------------------------
                                   ...
                                   1051 ;------------------------------------------------------------
                                   1052 ;	./Source/task2.c:89: static void performPeriodicTask( void ){
                                   1053 ;	-----------------------------------------
                                   1054 ;	 function performPeriodicTask
                                   1055 ;	-----------------------------------------
      004090                       1056 _performPeriodicTask:
                                   1057 ;	./Source/task2.c:98: P2=P1;
      004090 85 90 A0         [24] 1058 	mov	_P2,_P1
                                   1059 ;	./Source/task2.c:103: if(flag==true){
      004093 90 10 BC         [24] 1060 	mov	dptr,#_flag
      004096 E0               [24] 1061 	movx	a,@dptr
      004097 FF               [12] 1062 	mov	r7,a
      004098 BF 01 02         [24] 1063 	cjne	r7,#0x01,00109$
      00409B 80 03            [24] 1064 	sjmp	00110$
      00409D                       1065 00109$:
      00409D 02 40 B8         [24] 1066 	ljmp	00102$
      0040A0                       1067 00110$:
                                   1068 ;	./Source/task2.c:105: flag=false;
      0040A0 90 10 BC         [24] 1069 	mov	dptr,#_flag
      0040A3 74 00            [12] 1070 	mov	a,#0x00
      0040A5 F0               [24] 1071 	movx	@dptr,a
                                   1072 ;	./Source/task2.c:106: P0_1|=0x01;
      0040A6 90 10 BE         [24] 1073 	mov	dptr,#_performPeriodicTask_sloc0_1_0
      0040A9 04               [12] 1074 	inc	a
      0040AA F0               [24] 1075 	movx	@dptr,a
      0040AB A2 81            [12] 1076 	mov	c,_P0_1
      0040AD 90 10 BE         [24] 1077 	mov	dptr,#_performPeriodicTask_sloc0_1_0
      0040B0 E0               [24] 1078 	movx	a,@dptr
      0040B1 24 FF            [12] 1079 	add	a,#0xff
      0040B3 92 81            [24] 1080 	mov	_P0_1,c
      0040B5 02 40 CE         [24] 1081 	ljmp	00104$
      0040B8                       1082 00102$:
                                   1083 ;	./Source/task2.c:115: flag=true;
      0040B8 90 10 BC         [24] 1084 	mov	dptr,#_flag
      0040BB 74 01            [12] 1085 	mov	a,#0x01
      0040BD F0               [24] 1086 	movx	@dptr,a
                                   1087 ;	./Source/task2.c:116: P0_1&=~0x01;
      0040BE 90 10 BE         [24] 1088 	mov	dptr,#_performPeriodicTask_sloc0_1_0
      0040C1 74 00            [12] 1089 	mov	a,#0x00
      0040C3 F0               [24] 1090 	movx	@dptr,a
      0040C4 A2 81            [12] 1091 	mov	c,_P0_1
      0040C6 90 10 BE         [24] 1092 	mov	dptr,#_performPeriodicTask_sloc0_1_0
      0040C9 E0               [24] 1093 	movx	a,@dptr
      0040CA 24 FF            [12] 1094 	add	a,#0xff
      0040CC 92 81            [24] 1095 	mov	_P0_1,c
      0040CE                       1096 00104$:
      0040CE 22               [24] 1097 	ret
                                   1098 	.area CSEG    (CODE)
                                   1099 	.area CONST   (CODE)
                                   1100 	.area CABS    (ABS,CODE)
