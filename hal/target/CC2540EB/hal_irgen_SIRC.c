...
#define HAL_IRGEN_SIRC_CMD_SIZE    12
  ...
  // Carrier: 1/40Khz = 25 uSec 
  // Duty cycle: prescaler/tickspeed * periode 
  // 1/4MHz * 0x64 = 25 uSec
  // 25% Duty cycle; 0x64/4 = 0x19
  #define HAL_IRGEN_SIRC_CARRIER_DUTY_CYCLE  0x63 // Subtract one for 0th clk cycle
  #define HAL_IRGEN_SIRC_CARRIER_ACTIVE_PER  0x19

  // Bit signal active period: prescaler/tickspeed * periode
  // Tick input from T3 Ch1 (40KHz)
  // '1' : 1200 / 25 uSec = 48 = 0x0030
  // '0' : 600  / 25 uSec = 24 = 0x0018
  #define HAL_IRGEN_SIRC_BIT_1_PER   0x0030
  #define HAL_IRGEN_SIRC_BIT_0_PER   0x0018

#else
  // Bit signal active period: prescaler/tickspeed * periode
  // Tick input configured directly to 4MHz
  // '1' : 1200 uSec * 4MHz = 4800 = 0x12C0
  // '0' :  600 uSec * 4MHz = 2400 = 0x0960
  #define HAL_IRGEN_SIRC_BIT_1_PER   0x12C0
  #define HAL_IRGEN_SIRC_BIT_0_PER   0x0960
