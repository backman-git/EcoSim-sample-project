/**************************************************************************************************
  ...
  Revised:        $Date: 2011-04-26 13:55:32 -0700 (Tue, 26 Apr 2011) $
  Revision:       $Revision: 25793 $
...
{                                                                \
  ...
  __asm__("NOP");                                /* chip bug workaround */                            \
  for (i=0; i<504; i++) __asm__("NOP");          /* Require 63us delay for all revs */                \
...
#elif defined (HAL_BOARD_CC2530EB_REV17) && !defined (HAL_PA_LNA) && !defined (HAL_PA_LNA_CC2590)
