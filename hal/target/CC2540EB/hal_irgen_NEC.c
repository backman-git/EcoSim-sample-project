...
#define HAL_IRGEN_NEC_CMD_SIZE    32
  ...
  // Carrier: 1/38Khz = 26.315 uSec 
  // Duty cycle: prescaler/tickspeed * periode 
  // 1/4MHz * 0x69 = 26.25 uSec ~= 26.315 uSec
  // 33% Duty cycle; 0x69/3 = 0x23
  #define HAL_IRGEN_NEC_CARRIER_DUTY_CYCLE  0x68 // Subtract one for 0th clk cycle
  #define HAL_IRGEN_NEC_CARRIER_ACTIVE_PER  0x23

  // Bit signal duty cycle: prescaler/tickspeed * periode
  // Tick input from T3 Ch1 (38KHz)
  // '1' : 2250 / 26.25 uSec = 85.71 ~= 86 = 0x0056
  // '0' : 1120 / 26.25 uSec = 42.67 ~= 43 = 0x002B
  #define HAL_IRGEN_NEC_BIT_1_PER   0x0055 //subtract one for 0th clk cycle
  #define HAL_IRGEN_NEC_BIT_0_PER   0x002A //subtract one for 0th clk cycle
#else
  // Bit signal duty cycle: prescaler/tickspeed * periode
  // Tick input configured directly to 4MHz
  // '1' : 1/4MHz * 0x2328 = 2250 uSec
  // '0' : 1/4MHz * 0x1180 = 1120 uSec
  #define HAL_IRGEN_NEC_BIT_1_PER   0x2327 //subtract one for 0th clk cycle
  #define HAL_IRGEN_NEC_BIT_0_PER   0x1179 //subtract one for 0th clk cycle
...
#ifdef HAL_IRGEN_CARRIER
  // Active Periode: prescaler/tickspeed * periode 
  // Tick input from T3 Ch1 (38KHz)
  //  560 / 26.25 uSec = 21.33 ~= 21 = 0x0015
  static uint16 halIrGenCc1 = 0x0015;
#else
  // Tick input configured directly to 4MHz
  // 1/4MHz * 0x08C0 = 560 uSec
  static uint16 halIrGenCc1 = 0x08C0;
#endif // HAL_IRGEN_CARRIER
