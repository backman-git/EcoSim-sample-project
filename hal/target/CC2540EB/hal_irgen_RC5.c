...
#define HAL_IRGEN_RC5_CMD_SIZE    14
  ...
  // Carrier: 1/36Khz = 27.778 uSec 
  // Duty cycle: prescaler/tickspeed * periode 
  // 1/4MHz * 0x6F = 27.75 uSec ~= 27.778 uSec
  // 33% Duty cycle; 0x6F/3 = 0x25
  #define HAL_IRGEN_RC5_CARRIER_DUTY_CYCLE  0x6E // Subtract one for 0th clk cycle
  #define HAL_IRGEN_RC5_CARRIER_ACTIVE_PER  0x25

  // Bit signal duty cycle: prescaler/tickspeed * periode
  // Tick input from T3 Ch1 (36KHz)
  // half bit time ('1' and '0') : 889 uSec / 27.75 uSec = 32.036 ~= 32 = 0x0020
  #define HAL_IRGEN_RC5_BIT_BURST_PER   0x0020
#else
  // Bit signal duty cycle: prescaler/tickspeed * periode
  // Tick input configured directly to 4MHz
  // half bit time ('1' and '0'): 889 uSec * 4MHz = 3556 = 0x0DE4
  #define HAL_IRGEN_RC5_BIT_BURST_PER   0x0DE4
